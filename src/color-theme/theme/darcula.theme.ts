...
export const darculaTheme = new CssTheme({
    ...
    rules: {
        ...
        ".editor .code-area .CodeMirror pre": {
            color: "{{DEPRECATED Code Punctuation}}",
        }, // punctuation

        ".editor .code-area .CodeMirror-cursor": {
            "border-left": "1px solid {{DEPRECATED Cursor}}!important",
        },
        ".CodeMirror-focused div.CodeMirror-selected": {
            "background-color": "{{DEPRECATED textSelectionBackground}}",
        ...
        ".autocomplete": {
            "background-color": "{{DEPRECATED tabBackGround}}",
            color: "{{DEPRECATED listItem}}",
        },
        ...
        ".editor .code-area .CodeMirror-gutter-text": {
            "background-color": "{{DEPRECATED codeBackGround}}",
            "box-shadow":
                "-1px 0px 0px 0px {{DEPRECATED border}}, 1px 0px 0px 0px {{DEPRECATED border}}",
        }, // line number's background
        ".editor .code-area .CodeMirror-gutter-text pre": {
            color: "{{DEPRECATED Line numbers}}",
        }, // line number
        ...
        ".cm-s-default span.cm-variable": {
            color: "{{DEPRECATED Top level Variable}}",
        },
        ".cm-s-default span.cm-variable-2": {
            color: "{{DEPRECATED Local variable}}",
        },
        ".cm-s-default span.cm-variable-3": {
            color: "{{DEPRECATED Local variable}}",
        },
        ".cm-s-default span.cm-property": {
            color: "{{DEPRECATED Object properties}}",
        ...
        ".cm-s-default span.cm-string-2": {
            color: "{{DEPRECATED Regular expressions}}",
        }, // regular expression & CSS properties
        ".cm-s-default span.cm-meta": { color: "#555" },
        ".cm-s-default span.cm-error": {
            color: "{{DEPRECATED Errors in HTML}}",
        }, // erroneous HTML code like : "zer"zer class='zer'
        ".cm-s-default span.cm-qualifier": {
            color: "{{DEPRECATED CSS selectors}}",
        }, // CSS path
        ".cm-s-default span.cm-builtin": {
            color: "{{DEPRECATED CSS selectors}}",
        }, // used for CSS #id (a bug probably)
        ".cm-s-default span.cm-bracket": { color: "#997" },
        ".cm-s-default span.cm-tag": { color: "{{DEPRECATED HTML tag}}" }, // HTML tag
        ".cm-s-default span.cm-attribute": {
            color: "{{DEPRECATED HTML attribute}}",
        }, // HTML attribute
        ".cm-s-default span.cm-header": {
            color: "{{DEPRECATED HTML template}}",
        }, // HTML template token : <?=  ?>
        ...
        ".editor .gwt-TabLayoutPanelTab:hover .name, .editor .gwt-TabLayoutPanelTab-selected .tab-header .name":
            { color: "{{DEPRECATED generalText}}" },
        ".editor .gwt-TabLayoutPanelTab-selected": {
            "background-color": "{{DEPRECATED codeBackGround}}",
        },
        ".editor .gwt-TabLayoutPanelTab:hover": {
            "background-color": "{{DEPRECATED codeBackGround}}",
        },
        ...
        ".resource-list .project-items-list .item": {
            "border-bottom": "1px solid {{DEPRECATED border}}",
        },
        ...
        ".workspace .gwt-SplitLayoutPanel-HDragger:hover, .workspace .gwt-SplitLayoutPanel-VDragger:hover":
            { "background-color": "{{DEPRECATED Drag bar hoover}}!important" },
        ...
        ".workspace .aux-info .debugger-frame-label": {
            "background-color": "{{DEPRECATED listItemBackground}}",
        },
        ".workspace .aux-info .debugger-frame-label-selected": {
            "background-color": "{{DEPRECATED listItemBackgroundSelected}}",
            color: "{{DEPRECATED generalText}}",
        },
        ...
        ".workspace .aux-info .treetable-wrapper": {
            "border-left": "1px solid {{DEPRECATED border}}",
            "border-top": "1px solid {{DEPRECATED border}}",
        },
        ".workspace .aux-info .treetable-background-2": {
            "background-color": "{{DEPRECATED generalBackGround}}",
        },
        ".workspace .aux-info .treetable-background-1": {
            "background-color": "{{DEPRECATED listItem Background secondary}}",
        },

        // DEPRECATED Scrollbar
        ".CodeMirror-scroll.cm-s-default::-webkit-DEPRECATED Scrollbar-thumb": {
            "background-color": "{{DEPRECATED Scrollbar}}",
        },
